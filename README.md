...
1. Clone the repository
   ```bash
   git clone https://github.com/tchoumi313/Turf-Spot.git
   ```
...
For any inquiries or questions, please contact us at [tchouminzikeubd@gmail.com](mailto:tchouminzikeubd@gmail.com).
